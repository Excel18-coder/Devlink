...
router.patch("/me", requireAuth, requireRole("employer"), validate(updateEmployerSchema), asyncHandler(async (req, res) => {
...
// ─── Upload avatar ────────────────────────────────────────────────────────────
router.post("/me/avatar", requireAuth, requireRole("employer"), upload.single("avatar"), asyncHandler(async (req, res) => {
    if (!req.file)
