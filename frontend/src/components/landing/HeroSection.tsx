...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center hero-section overflow-hidden">
      ...
      <div className="absolute top-20 right-0 w-80 h-80 bg-primary/10 rounded-full blur-2xl" />
      <div className="absolute bottom-20 left-0 w-64 h-64 bg-accent/8 rounded-full blur-2xl" />
      ...
      <div className="container relative z-10 mx-auto px-4 pt-24 pb-16">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-secondary-foreground leading-tight mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Hire the world&apos;s best{" "}
            <span className="text-gradient">software talent</span>
          </h1>

          <p className="text-lg sm:text-xl text-secondary-foreground/60 max-w-xl mb-10 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="relative max-w-lg animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-secondary-foreground/5 border border-secondary-foreground/10 text-secondary-foreground placeholder:text-secondary-foreground/30 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/30 transition-all font-body"
            />
          </div>
        </div>
      </div>
