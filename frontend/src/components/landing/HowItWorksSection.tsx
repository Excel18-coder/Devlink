          ...
          {steps.map((item, index) => (
            <div key={item.step} className="relative animate-fade-in" style={{ animationDelay: `${index * 0.15}s` }}>
              ...
              <div className="relative">
                <span className="text-6xl font-heading font-bold text-primary/10">{item.step}</span>
                <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center -mt-6 mb-4">
